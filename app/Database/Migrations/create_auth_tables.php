...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'phone'            => ['type' => 'varchar', 'constraint' => 20, 'null' => true],  // Colonne facultative
            'region'           => ['type' => 'varchar', 'constraint' => 100, 'null' => true], // Colonne facultative
            'whatsapp'         => ['type' => 'varchar', 'constraint' => 20, 'null' => true],
            'avatar'           => ['type' => 'varchar', 'constraint' => 255, 'null' => true],  // Colonne pour le chemin de l'avatar
